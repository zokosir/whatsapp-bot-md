...
await message.client.sendMessage(message.jid, fs.readFileSync('./zoro/Mention.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
...
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./zoro/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
}
});
    }
...
await message.client.sendMessage(message.jid, fs.readFileSync('./zoro/Da.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        
const array = ['Sathan','Da  Black','help','I','Ayisheri','Okey','Kozhi','Tharuvo','Poo','Girl','Entry','kozhi','Entha','Friend','Jeevan','Line','Njan paavam','power','Poyi','rip','Seen','SHALIN','ABIJITH','Aleena','Aleena1','Aleena2','Aleena3','alive','Aliya mention','Aliya','Ayin','Bab','BFA KINGS','Black','Block','Bomb','Bot','By','Chunk','CNK BLACK','Di','Entea aniyan kuttan','Girl','git','Gudnyt','HERMIT sed','HERMIT','HERMIT1','hermitgirl','Hi','Hii','I love you','Idd','Ividea','Kannan','Karayallea','KING 1','KING sed','Kiss','Kudea','Kundan','LALETTAN','LFA KING','LFA','love me','Love vendada','LUCIFER THERI','LUCIFER','zoro','MFA SATHAN','Mood','Myr','Name','Nee','Njan verum','Oii','On','Onam','Onn','Oo','Ozhivaki','Paavam','Poda','Poli','Pro','Pubg','Rajasree','Rajavu','Remix','Rip','Set','Shalin','song','Thaniyea','Theap','Umbi','Vid','YR MEDIA HERMIT','YR MEDIA','YRMEDIA','Aliyaa','Aloo','Baa','Black','help','Jeevan','Line','Njan paavam','power','Poyi','rip','Seen','SHALIN']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./zoro/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
